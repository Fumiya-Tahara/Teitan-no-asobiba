...
(11, '食品ロス対策', '食べられる食品を捨ててしまう「食品ロス」の対策で正しいのは次のうちどれでしょう。', '食材は常に多めに購入する', 'フードバンクを利用する', '外食では食べたいものを好きなだけ注文する', '購入した食材の賞味、消費期限は気にしなくてよい', 2, 'フードバンクは食べきれない食材をもっていくとそれを必要な人に届けてくれるサービスだ！必要なものだけ買って、食べられるものだけを注文しよう！\r\n               ちなみに北九州ではフードバンク北九州ライフアゲインというサービスがあるぞ！保護者の方と利用してみるといいかもしれないぞ！？\r\n', ''),
...
--
-- Indexes for table `ranking_tbl`
--
ALTER TABLE `ranking_tbl`
  ADD PRIMARY KEY (`ranking_id`);

--
-- Indexes for table `typing_tbl`
--
ALTER TABLE `typing_tbl`
...
--
-- AUTO_INCREMENT for table `ranking_tbl`
--
ALTER TABLE `ranking_tbl`
  MODIFY `ranking_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `typing_tbl`
--
ALTER TABLE `typing_tbl`
  MODIFY `typing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
