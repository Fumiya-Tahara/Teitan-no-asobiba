...
<?php	
    $pdo = db();
        ...
        echo "<a href='quiz_add.php'>次</a>";
            ...
            echo '<p>タイトル<br><input type="text" name="title" class="input_quiz"></p>';
            echo '<p>問題文<br><textarea name="problem" class="input_text"></textarea></p>';
            echo '<p>選択肢１<br><input type="text" name="choices1" class="input_quiz"></p>';
            echo '<p>選択肢２<br><input type="text" name="choices2" class="input_quiz"></p>';
            echo '<p>選択肢３<br><input type="text" name="choices3" class="input_quiz"></p>';
            echo '<p>選択肢４<br><input type="text" name="choices4" class="input_quiz"></p>'; 
            echo '<p>正解<br><input type="text" name="right_answer"></p>';
            echo '<p>解説<br><textarea name="commentary" class="input_text"></textarea></p>';
            echo '<p>URL<br><input type="text" name="url" class="input_quiz"></p>';
